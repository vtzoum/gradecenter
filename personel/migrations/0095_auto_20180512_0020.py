...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('personel', '0094_auto_20180512_0019'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='acceptance',
            name='statusTime',
            field=models.DateTimeField(blank=True, default=b'2018-05-12 00:20:24'),
        ),
        migrations.AlterField(
            model_name='booking',
            name='actionTime',
            field=models.DateTimeField(default=b'2018-05-12 00:20:24'),
        ),
        migrations.AlterField(
            model_name='lesson',
            name='acceptances',
