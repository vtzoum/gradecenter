...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('personel', '0028_auto_20160828_2221'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='acceptance',
            name='statusTime',
            field=models.DateTimeField(blank=True, default=b'2016-08-28 22:21:18'),
        ),
        migrations.AlterField(
            model_name='booking',
            name='actionTime',
            field=models.DateTimeField(default=b'2016-08-28 22:21:18'),
        ),
        migrations.AlterField(
            model_name='lesson',
            name='acceptances',
