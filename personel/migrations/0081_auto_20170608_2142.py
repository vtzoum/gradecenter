...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('personel', '0080_auto_20170608_2142'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='acceptance',
            name='statusTime',
            field=models.DateTimeField(blank=True, default=b'2017-06-08 21:42:23'),
        ),
        migrations.AlterField(
            model_name='booking',
            name='actionTime',
            field=models.DateTimeField(default=b'2017-06-08 21:42:23'),
        ),
        migrations.AlterField(
            model_name='lesson',
            name='acceptances',
