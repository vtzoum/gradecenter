...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('personel', '0083_auto_20170612_1519'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='acceptance',
            name='statusTime',
            field=models.DateTimeField(blank=True, default=b'2017-06-12 15:19:27'),
        ),
        migrations.AlterField(
            model_name='booking',
            name='actionTime',
            field=models.DateTimeField(default=b'2017-06-12 15:19:27'),
        ),
        migrations.AlterField(
            model_name='lesson',
            name='acceptances',
