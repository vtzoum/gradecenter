...
urlpatterns = [    
    ...
    #ROOTHome
    #################################
    url(r'^$', TemplateView.as_view(template_name='ui-final/home.html'), name='base'),    
    url(r'^home/$', TemplateView.as_view(template_name='ui-final/home.html'), name='home'),
    url(r'^land/$', TemplateView.as_view(template_name='ui-final/home-land.html'), name='homeland'),
    ...
    # final > ui
    #################################
    url(r'^about/$', TemplateView.as_view(template_name='ui-final/about.html')),    
    #RELATIONSHIP(M:N)        
    url(r'^acceptance/$', staff_or_403(TemplateView.as_view(template_name='ui-final/acceptance.html'))),    
    ...
    #RELATIONSHIP(M:N)        
    url(r'^booking/$', group_required_or_403('Grammateia', 'Filaxi', 'Apothiki')(TemplateView.as_view(template_name='ui-final/booking.html'))),
    url(r'^booking1/$', group_required_or_403('Grammateia', 'Filaxi', 'Apothiki')(TemplateView.as_view(template_name='ui-final/booking+v1.html'))),
    url(r'^booking2/$', group_required_or_403('Grammateia', 'Filaxi', 'Apothiki')(TemplateView.as_view(template_name='ui-final/booking+v2.html'))),
    url(r'^booking/crud/$', personel.viewsErRelMn.jsonBookingCrud),
    url(r'^booking/post/$', personel.viewsErRelMn.jsonBookingPost),
    
    url(r'^books/$', staff_or_403(TemplateView.as_view(template_name='ui-final/books.html'))),

    #RELATIONSHIP(1:N)        
    #url(r'^folders/$', TemplateView.as_view(template_name='ui-final/folders.html')), 
    url(r'^folder/$', staff_or_403(TemplateView.as_view(template_name='ui-final/folder.html'))),
    url(r'^folder/crud/$', personel.viewsErRel1N.jsonFolderCrud), #graders accessed by lessons 

    #RELATIONSHIP(M:N)        
    url(r'^grader/$', staff_or_403(TemplateView.as_view(template_name='ui-final/grader.html'))),
    ...
    #ENTITY**KERNEL**
    url(r'^lesson/$', staff_or_403(TemplateView.as_view(template_name='ui-final/lesson.html'))),
    url(r'^lesson/crud/$', personel.viewsErCrud.jsonLessonCrud),
    url(r'^lesson/status/$', personel.viewsErCrud.jsonLessonStatus),
    url(r'^lesson/upload/$', staff_or_403(TemplateView.as_view(template_name='ui-final/lesson+upload.html'))),
    url(r'^lesson/upload/import/$', staff_or_403(personel.viewsFileUpload.jsonFileCSVImportLesson)),

    #RELATIONSHIP(M:N)        
    url(r'^registry/$', staff_or_403(TemplateView.as_view(template_name='ui-final/registry.html'))),
    ...
    url(r'^schoolstograde/upload/$', staff_or_403(TemplateView.as_view(template_name='ui-final/schoolstograde+upload.html'))),
    url(r'^schoolstograde/upload/import/$', staff_or_403(personel.viewsFileUpload.jsonFileCSVImportSchoolToGrade)),
    
    #ENTITY
    url(r'^specialty/$', staff_or_403(TemplateView.as_view(template_name='ui-final/specialty.html'))),
    url(r'^specialty/crud/$', staff_or_403(personel.viewsErCrud.jsonSpecialtyCrud)),
    url(r'^specialty/upload/$', staff_or_403(TemplateView.as_view(template_name='ui-final/specialty+upload.html'))),
    url(r'^specialty/upload/import/$', staff_or_403(personel.viewsFileUpload.jsonFileCSVImportSpecialty)),
    
    #ENTITY
    url(r'^teacher/$', staff_or_403(TemplateView.as_view(template_name='ui-final/teacher.html'))),
    url(r'^teacher/crud/$', personel.viewsErCrud.jsonTeacherCrud),
    url(r'^teacher/upload/$', staff_or_403(TemplateView.as_view(template_name='ui-final/teacher+upload.html'))),
