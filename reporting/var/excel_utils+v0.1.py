...
def doXlsHeader(workbook, worksheet, lesson=None):
    ...
    # Lesson title @ 3rd row / keep 2nd for report_title
    lesson_text = u"ΜΑΘΗΜΑ:" + lesson.name if lesson else ugettext(u"ΟΛΑ ΤΑ ΜΑΘΗΜΑΤΑ")
...
def doXlsAcceptanceSum (dataDB, lesson=None):
    ...
    worksheet_s.write(start_row, 0, ugettext(u"AA"), header_STYLE)
    worksheet_s.write(start_row, 1, ugettext(u"Μάθημα"), header_STYLE)
    worksheet_s.write(start_row, 2, ugettext(u"Σύνολο Τετραδίων"), header_STYLE)
    #worksheet_s.write(4, 4, ugettext(u"Πλήθος Φακέλων"), header_STYLE)
    worksheet_s.write(start_row, 3, ugettext(u"Σύνολο Απουσιών"), header_STYLE)
    worksheet_s.write(start_row, 4, ugettext(u"Σύνολο Μηδενισμένων"), header_STYLE)
    ...
    for idx, data in enumerate(dataDB):
        ...
        val = data['sumBooks']
        worksheet_s.write_number(row, 2, val, cellC_STYLE)        
...
def doXlsBooking (dataDB, lesson=None):
    ...
    worksheet_s.write(start_row, 0, ugettext(u"AA"), header_STYLE)
    worksheet_s.write(start_row, 1, ugettext(u"Μάθημα"), header_STYLE)
    worksheet_s.write(start_row, 2, ugettext(u"Σταθμός"), header_STYLE)
    worksheet_s.write(start_row, 3, ugettext(u"Πράξη"), header_STYLE)
    worksheet_s.write(start_row, 4, ugettext(u"Ημ-νία Ώρα"), header_STYLE)
    worksheet_s.write(start_row, 5, ugettext(u"Φακ"), header_STYLE)
    worksheet_s.write(start_row, 6, ugettext(u"Βαθμολογήτής"), header_STYLE)
    ...
    for idx, data in enumerate(dataDB):
        ...
        val = data.actionTime
        worksheet_s.write(row, 4, val.strftime('%d/%m/%Y %H:%M'), cellC_STYLE)        
...
def doXlsBookingWeekdays (dataDB, lesson=None):
    ...
    # Report title
    report_title = u"ΗΜΕΡΕΣ ΕΡΓΑΣΙΑΣ ΒΑΘΜΟΛΟΓΗΤΩΝ ΑΝΑ ΗΜΕΡΑ"
    #worksheet_s.merge_range(report_title_cellspan, report_title, title_STYLE)
    worksheet_s.write('D2', report_title, title_STYLE)
    ...
    #start_row=4    
    worksheet_s.write(start_row, 0, ugettext(u"AA"), header_STYLE)
    worksheet_s.write(start_row, 1, ugettext(u"Ημ-νία"), header_STYLE)    
    worksheet_s.write(start_row, 2, ugettext(u"Μάθημα"), header_STYLE)
    worksheet_s.write(start_row, 3, ugettext(u"Επώνυμο"), header_STYLE)
    worksheet_s.write(start_row, 4, ugettext(u"Όνομα"), header_STYLE)
    worksheet_s.write(start_row, 5, ugettext(u"Πράξεις"), header_STYLE)    
    worksheet_s.write(start_row, 6, ugettext(u"Διάρκεια"), header_STYLE)   
    #worksheet_s.write(4, 4, ugettext(u"Πλήθος Φακέλων"), header_STYLE)
    ...
    for idx, data in enumerate(dataDB):
        ...
        worksheet_s.write(row, 1, val, cellC_STYLE)        
    ...
    # change column widths
    worksheet_s.set_column('B:B', date_col_width)  # Lesson column
    worksheet_s.set_column('C:C', lesson_col_width)  # Lesson column
    worksheet_s.set_column('D:E', names_col_width)  # Lesson column
...
def doXlsBookingWeekendsSum (dataDB, lesson=None):
    ...
    # Report title
    report_title = u"ΣΑΒΒΑΤΟΚΥΡΙΑΚΑ ΕΡΓΑΣΙΑΣ ΒΑΘΜΟΛΟΓΗΤΩΝ"
    #worksheet_s.merge_range(report_title_cellspan, report_title, title_STYLE)
    worksheet_s.write('D2', report_title, title_STYLE)
...
def doXlsFolder (dataDB, lesson=None):
    ...
    worksheet_s.write(start_row, 3, ugettext(u"Τύπος"), header_STYLE)
    worksheet_s.write(start_row, 4, ugettext(u"Κατάσταση"), header_STYLE)
    worksheet_s.write(start_row, 5, ugettext(u"Θέση"), header_STYLE)
    worksheet_s.write(start_row, 6, ugettext(u"Τετράδια"), header_STYLE)
    ...
    for idx, data in enumerate(dataDB):
        ...
        val = data.no
        worksheet_s.write_number(row, 2, val, cell_STYLE)
...
def doXlsFolderSum (dataDB, lesson=None):
    ...
    worksheet_s.write(start_row, 2, ugettext(u"Τύπος"), header_STYLE)
    worksheet_s.write(start_row, 3, ugettext(u"Κατάσταση"), header_STYLE)
    worksheet_s.write(start_row, 4, ugettext(u"Θέση"), header_STYLE)
    worksheet_s.write(start_row, 5, ugettext(u"Πλήθος"), header_STYLE)
